...
public class State_Attack02 : State
{
    float force = 0.2f;
    public State_Attack02(PlayerController pi, Animator animator, StateMachine stateMachine, int stateName)
    {
        this.pi = pi;
    ...
    public override void GameLogic()
    {
        ...
        {
            stateMachine.ChangeState(PlayerState.Attack03);
            return;
        }
